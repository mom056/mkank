...
export default function Booking() {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            const filteredData = data.filter(post => post.contractType === 'Booking');
                                    ...
                                    <div className="row border-bottom">
                                        <div className="col-md-4">
                                            <div className="position-relative overflow-hidden rounded-top image-realty-filter">
                                                ...
                                                <div className={`bg-${post.contractType === 'Booking' ? 'secondary' : 'primary'} rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3`}>
                                                    {post.contractType}
                                                </div>
